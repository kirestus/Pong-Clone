...
struct DataStruct{
    ...
    std::shared_ptr<sf::RenderWindow> pRenderWindow = std::make_unique<sf::RenderWindow>(sf::VideoMode(1024,768), "PongClone");
    ...
    std::shared_ptr<Ball> pBall = std::make_unique<Ball>(pRenderWindow);
